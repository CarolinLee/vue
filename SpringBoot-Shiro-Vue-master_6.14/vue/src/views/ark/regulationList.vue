<template>
  <div class="app-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-row>
          <el-form-item label="政策名称">
            <el-input size="small" style="width:130px;" @keyup.enter.native="onSubmit" v-model="listQuery.policyName" placeholder="政策名称" clearable></el-input>
          </el-form-item>
          <el-form-item label="政策代号">
            <el-input size="small" style="width:130px;" @keyup.enter.native="onSubmit" v-model="listQuery.policyCode" placeholder="政策代号" clearable></el-input>
          </el-form-item>
          <el-form-item label="行政部门">
            <el-input size="small" style="width:130px;" @keyup.enter.native="onSubmit" v-model="listQuery.department" placeholder="行政部门" clearable></el-input>
          </el-form-item>
          <el-form-item label="风险等级">
            <el-input size="small" style="width:130px;" @keyup.enter.native="onSubmit" v-model="listQuery.riskLevel" placeholder="风险等级" clearable></el-input>
          </el-form-item>
          <el-form-item label="业务影响">
            <el-input size="small" style="width:130px;" @keyup.enter.native="onSubmit" v-model="listQuery.bizEffect" placeholder="业务影响" clearable></el-input>
          </el-form-item>
          <el-form-item>
            <el-button icon="el-icon-search" @click="onSubmit"  circle></el-button>
            <el-button type="danger" icon="el-icon-delete" @click="refreshFun"  circle></el-button>
          </el-form-item>
        </el-row>
      </el-form>
    </div>
    <el-table ref="table" :data="list" :default-sort = "{prop: 'index', order: 'descending'}" :height="tableHeight" v-loading.body="listLoading"  element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" show-overflow-tooltip id="policyName" label="政策名称" prop="policyName" width="300" ></el-table-column>
      ...
      <el-table-column sortable='custom' align="center" show-overflow-tooltip label="关键词" prop="keyWord" width="150"></el-table-column>
...
<script>
  ...
  export default {
    data() {
      return {
        ...
        listQuery: {
          ...
          riskLevel:'',
          bizEffect:'',
          //updated by qiqli start 2019-6-13
          linkedEcommerce:this.$route.params.linkedEcommerce?this.$route.params.linkedEcommerce:''
          //updated by qiqli end 2019-6-13
    ...
    created() {
      ...
      //updated by qiqli start
      if(this.$route.params.linkedEcommerce == null || this.$route.params.linkedEcommerce != 'Y'){
        this.getList();
      }else{
        this.onSubmit();
      }
      //updated by qiqli end
    ...
    methods: {
      ...
      onSubmit() {
        this.api({
          ...
          //console.log("_index:"+data.list[_index].policyCode);
          //解析JSONOBJECT-start-mwz
          //var jsonObj = JSON.parse(JSON.stringify(data.list));
          var code = [] ;
          var codearray = [] ;
          for (var i = 0; i < data.list.length; i++) {
            if (data.list[i].policyCode != undefined  ){
              this.policyCodes[i] = data.list[i].policyCode;
              code[i] = data.list[i].policyCode.trim();
