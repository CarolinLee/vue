    ...
    methods: {
      ...
      getList() {
        ...
        this.api({
          ...
          this.list = data.list;
          this.users = data.list.users;//mwz-test
          var arr = [];
          console.log("start+"+data.list.length+"+end");
          for (var k=0;k<data.list.length;k++){
             arr.push(data.list[k].users);
          }
          //console.log(arr);
          this.users= arr;
          //console.log(arr[0][0].nickname)
          console.log(this.users[0][0].nickname);
